                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ $product->options['thumbnail'] }}" class="img-fluid rounded-3"
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex flex-row">
                                            <p class="mb-0" style="font-weight: 500;">{{ $product->qty }}</p>
                                        </div>
                                    </td>
                                    <td class="align-middle">
                                        <p class="mb-0" style="font-weight: 500;">{{ $product->price*$product->qty }}$</p>
                                    </td>
                                    <td class="align-middle">
                                        <a class="cart_quantity_delete" style="font-weight: 500;">
